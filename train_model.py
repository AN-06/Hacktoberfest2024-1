...
# Define paths
image_path = r'C:\Users\abhir\Desktop\REFUGE2\train\images'
mask_path = r'C:\Users\abhir\Desktop\REFUGE2\train\mask'

# Define image size and batch size
IMG_HEIGHT, IMG_WIDTH = 224, 224
BATCH_SIZE = 16

# Define a simple UNet model for demonstration
...
model_checkpoint = ModelCheckpoint('unet_model.keras', monitor='val_loss', save_best_only=True)
